...
Public NotInheritable Class CHSRRoleProvider
    ...
    Public Overloads Sub AddUsersToRoles(ByVal usernames As String(), ByVal rolenames As String(), ByVal programfk As Integer)
        ...
        Dim conn As SqlConnection = New SqlConnection(connectionString)
        Dim cmd As SqlCommand = New SqlCommand("INSERT INTO UsersInRoles " & _
          " (Username, Rolename, ApplicationName, programfk) " & _
          " Values(@Username, @Rolename, @ApplicationName, @ProgramFK)", conn)
